...
这是全新架构周期的治理与架构基线。仓库当前只包含协作规范、GitHub 模板、项目 Skill、流程校验和
[初版架构](docs/ARCHITECTURE.md)，不包含应用代码、依赖、数据库结构、Agent、RAG、外部集成或部署实现。

技术栈、系统边界、数据所有权、安全模型和交付路线以 Architecture Issue 与架构文档为准，再以一个个可验收
