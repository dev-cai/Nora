...
| 组件 | Issue | 说明 |
| :--- | :--- | :--- |
| Artifact/Source 生命周期决策 | #163 | 所有权、跨存储一致性、访问、删除、恢复与 M5 继承 |
| 公司情报版本边界决策 | #164 | 固定与 DecisionCase/DecisionReport 的版本关系和兼容策略 |
...
| Jenkins CD | #153 | 消费运行基线，从固定版本自动部署、冒烟并安全停止或回滚 |
| Beta 浏览器 E2E | #165 | apply 到手工投递记录、恢复、隔离与外部写关闭 |
...
- [ ] #163、#164 的 Architecture 门禁完成；
- [ ] #21、#79、#87、#91-#94、#138、#140、#153、#165 全部交付；
