...
export function createAppRouter(pinia: Pinia) {
  const router = createRouter({
    ...
    routes: [
      ...
      { path: "/interviews", name: "interviews", component: () => import("@/views/InterviewsView.vue"), meta: { requiresAuth: true, title: "面试安排" } },
      { path: "/interviews/new", name: "interview-new", component: () => import("@/views/InterviewCreateView.vue"), meta: { requiresAuth: true, title: "记录面试" } },
      { path: "/interviews/:id", name: "interview-detail", component: () => import("@/views/InterviewDetailView.vue"), meta: { requiresAuth: true, title: "面试详情" } },
